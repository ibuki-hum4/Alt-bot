...
func (_q *GuildQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *GuildQuery) FirstIDX(ctx context.Context) int {
...
func (_q *GuildQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *GuildQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *GuildQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *GuildQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *GuildQuery) ForUpdate(opts ...sql.LockOption) *GuildQuery {
...
func (_q *GuildQuery) ForShare(opts ...sql.LockOption) *GuildQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
