...
var (
	...
	// StickyMessagesColumns holds the columns for the "sticky_messages" table.
	StickyMessagesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "guild_id", Type: field.TypeString},
		{Name: "channel_id", Type: field.TypeString},
		{Name: "content", Type: field.TypeString, Size: 2147483647},
		{Name: "last_message_id", Type: field.TypeString, Default: ""},
		{Name: "enabled", Type: field.TypeBool, Default: true},
		{Name: "created_by", Type: field.TypeString, Default: ""},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
	}
	// StickyMessagesTable holds the schema information for the "sticky_messages" table.
	StickyMessagesTable = &schema.Table{
		Name:       "sticky_messages",
		Columns:    StickyMessagesColumns,
		PrimaryKey: []*schema.Column{StickyMessagesColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "stickymessage_channel_id",
				Unique:  true,
				Columns: []*schema.Column{StickyMessagesColumns[2]},
			},
			{
				Name:    "stickymessage_guild_id",
				Unique:  false,
				Columns: []*schema.Column{StickyMessagesColumns[1]},
			},
		},
	}
