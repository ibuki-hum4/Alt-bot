...
func (_q *TransactionLogQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *TransactionLogQuery) FirstIDX(ctx context.Context) int {
...
func (_q *TransactionLogQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *TransactionLogQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *TransactionLogQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *TransactionLogQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TransactionLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(transactionlog.Table, transactionlog.Columns, sqlgraph.NewFieldSpec(transactionlog.FieldID, field.TypeInt))
	_spec.From = _q.sql
